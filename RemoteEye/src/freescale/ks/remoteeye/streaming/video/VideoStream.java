...
import freescale.ks.remoteeye.streaming.MediaStream;
import freescale.ks.remoteeye.streaming.Stream;
import freescale.ks.remoteeye.streaming.exceptions.CameraInUseException;
import freescale.ks.remoteeye.streaming.exceptions.ConfNotSupportedException;
import freescale.ks.remoteeye.streaming.exceptions.InvalidSurfaceException;
import freescale.ks.remoteeye.streaming.hw.EncoderDebugger;
import freescale.ks.remoteeye.streaming.hw.NV21Convertor;
import freescale.ks.remoteeye.streaming.rtp.MediaCodecInputStream;
...
public abstract class VideoStream extends MediaStream {
	...
	protected void encodeWithMediaCodec() throws RuntimeException, IOException {
		if (mMode == MODE_MEDIACODEC_API_2) {
			...
			Log.e(TAG, ".........encoded using the MediaCode API with a surface........");
			encodeWithMediaCodecMethod2();
		} else {
			// Uses dequeueInputBuffer to feed the encoder
			Log.e(TAG, ".........encoded using the MediaCode API with a dequeueInputBuffer........");
