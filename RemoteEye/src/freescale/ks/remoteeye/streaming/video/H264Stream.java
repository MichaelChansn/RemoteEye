...
import freescale.ks.remoteeye.streaming.exceptions.ConfNotSupportedException;
import freescale.ks.remoteeye.streaming.exceptions.StorageUnavailableException;
import freescale.ks.remoteeye.streaming.hw.EncoderDebugger;
import freescale.ks.remoteeye.streaming.mp4info.MP4Config;
import freescale.ks.remoteeye.streaming.rtp.H264Packetizer;
...
public class H264Stream extends VideoStream {
	...
	public synchronized void start() throws IllegalStateException, IOException {
		...
		if (!mStreaming) {
			...
			Log.e(TAG, "........in H264Stream.start() Begin.....");
			byte[] pps = Base64.decode(mConfig.getB64PPS(), Base64.NO_WRAP);
			byte[] sps = Base64.decode(mConfig.getB64SPS(), Base64.NO_WRAP);
			((H264Packetizer)mPacketizer).setStreamParameters(pps, sps);
			Log.e(TAG, "........in H264Stream.start() ENd.....");
			super.start();
		}
	}
	...
	public synchronized void configure() throws IllegalStateException, IOException {
		Log.e(TAG, "........H264Stream configure() START.........");
		super.configure();
		mMode = mRequestedMode;
		mQuality = mRequestedQuality.clone();
		mConfig = testH264();
		Log.e(TAG, "........H264Stream configure() END.........");
	}
	...
	private MP4Config testMediaCodecAPI() throws RuntimeException, IOException {
		Log.e(TAG, "........H264Stream testMediaCodecAPI()   1.........");
		createCamera();
		updateCamera();
		Log.e(TAG, "........H264Stream testMediaCodecAPI()  2.........");
		try {
			...
			Log.e(TAG, "........H264Stream testMediaCodecAPI()  3.........");
			//这行代码在硬件差的手机上有问题
			...
			Log.e(TAG, "........H264Stream testMediaCodecAPI()  4.........");
	...
	private MP4Config testMediaRecorderAPI() throws RuntimeException, IOException {
		...
		final String TESTFILE = Environment.getExternalStorageDirectory().getPath()+"/ks_shot.mp4";
