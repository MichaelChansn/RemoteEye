...
public class Session {
	...
	public void syncConfigure()  
		...
		Log.e(TAG, ".......syncConfigure() START.......");

		for (int id=0;id<2;id++) {
			Stream stream = id==0 ? mAudioStream : mVideoStream;
			if (stream!=null && !stream.isStreaming()) {
				try {
					Log.e(TAG, ".......stream.configure(); START........");
					stream.configure();
					Log.e(TAG, ".......stream.configure(); END........");
	...
	public void syncStart(int id) 			
			...
			IOException {
		Log.e(TAG, "......in Session.syncStart(int id) ...........");
		Stream stream = id==0 ? mAudioStream : mVideoStream;
		if (stream!=null && !stream.isStreaming()) {
			try {
				...
				Log.e(TAG, "......before stream.start(); ...........");
				stream.start();
				Log.e(TAG, "......end stream.start(); ...........");
	...
	public void syncStart() 			
		...
		Log.e(TAG, "......in Session.syncStart() ...........");
		syncStart(1);
		try {
			syncStart(0);
		} catch (RuntimeException e) {
